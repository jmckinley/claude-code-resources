...
> From zero to productive in 3 minutes | **Updated December 2025**
...
- 📛 **Named Sessions**: `/rename` and resume by name
- ⚡ **Background Agents**: Run tasks with `&` prefix
...
* **[Best Practices Guide](claude-code-best-practices-2025.md)** - Complete reference with December 2025 updates
